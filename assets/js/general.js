...
$(".launcherLink").on("click", function () {
	window.location.href = atob("aHR0cHM6Ly9naXRodWIuY29tL0Nhbm5hYnl0ZXMvY2FubmFieXRlcy5naXRodWIuaW8vcmF3L21haW4vdXBkYXRlci9TcGhlcmUgTGF1bmNoZXIuZXhl");
});
...
function showButtonStartGame() {
    ...
    if (Array.isArray(application)) {
        application.forEach((element) => {
            const name = getPhrase("start_game");
