let phrase = {
    "ru": {
		...
		"comparison_files" : "По умолчанию: 20MB<br>Работает так: Во время нажатия обновление патча, идет сверка файлов Вашего игрового клиента и файлов патча сервера.<br>Большие файлы, можно сравнивать по кол-во их размеру, Вам необходимо указать размер больших файлов.",
		...
		"create patch" : "Создание патча",
		"you need to update" : "Ваш лаунчер устарел. Вам необходимо обновиться.",
		
		"update_launcher" : "Обновить лаунчер",
		"game patch folder" : "Папка с патчем игры",
		"specify folder" : "Указать папку",
		"archive storage location" : "Место сохранения архивов",
		"begin" : "Начать",
		"abort" : "Прервать",
		"instructions for creating a patch" : "Инструкция создания патча",
		"description of patch creation" : `Для создания патча, необходимо запустить лаунчер.<br>
							...
							Загрузите всё содержимое себе на сайт, например по такому адресу <label class="text-success">https://example.com/updater/patch/</label>.`,
		"instruction contact" : 'Далее передайте в телеграмм <a target="_blank" href="https://t.me/Cannabytes">@Cannabytes</a> ссылки на патч лист и клиент.',
		"link_patch_example" : "Ссылку на патч лист",
		"link_save_patch_example" : "Ссылку на местохранение патча",
		"instruction_security and activation in the system" : "Это необходимо для безопасности и активации в системе.",
		"good congratulations" : "Congratulations! Ура, если всё получилось.",
    ...
    "en": {
		...
		"comparison_files" : "Default: 20MB<br>It works like this: When you click update patch, the files of your game client and the server patch files are compared.<br>Large files can be compared by the number of their sizes, you need to indicate the size of large files.",
		...
		"create patch" : "Create Patch",
		"you need to update" : "Your launcher is out of date. You need to update.",
		
		"update_launcher" : "Update launcher",
		"game patch folder" : "Game patch folder",
		"specify folder" : "Specify folder",
		"archive storage location" : "Archive storage location",
		"begin" : "Start",
		"abort" : "Abort",
		"instructions for creating a patch" : "Instructions for creating a patch",
		"description of patch creation" : `To create a patch, you need to launch the launcher.<br>
		Specify the folder with the client or game patch.<br>
		Specify the archiving save folder.<br>
		After clicking on the "Start" button, the process of archiving and calculating file hashes will start.<br>
		After completion, the folder with the patch will contain a file <label class="text-success">client.csv</label> and archives in folders.<br>
		Upload all the content to your website, for example at this address <label class="text-success">https://example.com/updater/patch/</label>.`,
		"instruction contact" : 'Next, send links to the patch list and client to <a target="_blank" href="https://t.me/Cannabytes">@Cannabytes</a> in telegram.',
		"link_patch_example" : "Link to patch sheet",
		"link_save_patch_example" : "Link to patch location",
		"instruction_security and activation in the system" : "This is required for security and activation in the system.",
		"good congratulations" : "Congratulations! Hurray if everything worked out.",
...
$('.nav-main-submenu .nav-main-link-name:contains("English")').on('click', function() {
    setCookie("lang", 'en', 365);
	location.reload()
});
$('.nav-main-submenu .nav-main-link-name:contains("Russian")').on('click', function() {
...
if(!getCookie("lang")){
		...
		let userLang = userLanguage.substring(0, 2);
